...
def get_pose_diff_in_rad(pred_tform4x4: torch.Tensor, gt_tform4x4: torch.Tensor):
    ...
    pred_ref_tform_src_scaled[..., :3, :3] /= torch.linalg.norm(
        pred_ref_tform_src_scaled[..., :3, :3],
        dim=-1,
        keepdim=True,
    )

    gt_ref_tform_src_scaled = gt_tform4x4.clone()
    gt_ref_tform_src_scaled[..., :3, :3] /= torch.linalg.norm(
        gt_ref_tform_src_scaled[..., :3, :3],
        dim=-1,
        keepdim=True,
    )
    diff_rot3x3 = rot3x3(
        inv_tform4x4(gt_ref_tform_src_scaled)[..., :3, :3],
        pred_ref_tform_src_scaled[..., :3, :3],
    )[..., :3, :3]
