...
from od3d.utils import cal_occ_one_image
from od3d.utils import CameraTransformer
from od3d.utils import load_off
from od3d.utils import Projector3Dto2D
from od3d.utils.pascal3d_utils import get_anno
...
class MeshConverter:
    ...
    def get_one(self, annos, return_distance=False):
        ...
        box_cropped = bbt.from_numpy(get_anno(annos, "box_obj").astype(int))
        box_cropped.set_boundary(
            get_anno(annos, "box_obj").astype(int)[4::].tolist()
        )
