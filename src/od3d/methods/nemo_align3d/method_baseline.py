                    ...
                    for s, src_mesh_id in enumerate(src_mesh_ids):
                        ...
                        if r > 0 and (
                            ...
                            if self.config.global_optimization_steps > 1 and i > 0:
                                ...
                                src_tform4x4_ref, models, scores, best_correspondence, best_ref_correspondence, best_geo_dist, best_appear_dist, src_tform4x4_ref_score  = ransac(
                                    pts=pts_ref,
                                    fit_func=partial(
                                        fit_tform4x4,
                                        pts_ref=pts_src,
                                ...
                                from od3d.cv.visual.correspondences_vis import save_visualization_mesh, save_visualization_mesh_with_color

                                partial_ratio_for_saving = src_sequences[src_mesh_id].partial_ratio
                                start_frame_id_for_saving = src_sequences[src_mesh_id].start_frame_id
                                ...
                                category_ratio_use_sph_path = os.path.join(vi_mesh_path, f'{category}_partial_ratio_{partial_ratio_for_saving}_start_frame_{start_frame_id_for_saving}_use_sph_{use_sph}_use_sd_{use_sd}')
                                ...
                                folder_path_flip = os.path.join(sfm_pcl_type_path, f'ref_id_{ref_name}_src_id_{src_name}_aligned_flip')
                                ...
                                ref_pts3d, ref_pts3d_colors, ref_pts3d_normals = ref_sequences[
                                    ref_mesh_id
                                ].read_pcl()
                                ...
                                save_visualization_mesh_with_color(pts= pts_src, pts_ref= pts_ref, pts_ids= best_correspondence, pts_ref_ids= best_ref_correspondence, filename= os.path.join(sfm_pcl_type_path, f'ref_id_{ref_name}_src_id_{src_name}'),
                                ...
                                os.makedirs(os.path.join(sfm_pcl_type_path, f'{category}'), exist_ok= True)
