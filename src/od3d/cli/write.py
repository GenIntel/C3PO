...
def sequence():
    ...
    sequence = co3d.get_sequence_by_category_and_name(
    ...
    mesh.verts = transf3d_broadcast(
        mesh.verts,
        sequence.zsp_labeled_cuboid_ref_tform_obj,
    )
    ...
    if flag_show_scene:
        imgs = show_scene(
            ...
            viewpoints_count=2,
            pts3d=[torch.cat(viewpoints, dim=0)],
        )
