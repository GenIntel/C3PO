...
from od3d.uni_rep.rep_3d import Geometry
from od3d.uni_rep.rep_3d.dmtet_utils import get_center_boundary_index
...
class DMTetGeometry(Geometry):
    def __init__(
        ...
        self.device = device
        self.args = args
        tets = np.load(get_abs_path('data/tets/%d_compress.npz' % (grid_res)))
