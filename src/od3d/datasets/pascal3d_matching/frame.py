...
class Pascal3DFrameMeta(OD3D_FrameMetaKpts2D3DMixin, OD3D_FrameMetaBBoxMixin, OD3D_FrameMetaSubsetMixin,
    ...
    def load_from_raw_annotation(annotation, subset: str, category: str, path_raw: Path, rpath_meshes: Path, rfpath_rgb: Path):
        ...
        category, mesh_index, rfpath_mesh, bbox, kpts_names, kpts2d_annot, kpts2d_annot_vsbl, cam_tform4x4_obj, cam_intr4x4 = Pascal3DFrameMeta.load_category_mesh_bbox_kpts2d_cam_from_object_annotation_raw(object=object, rpath_meshes=rpath_meshes)
...
from od3d.datasets.frame import OD3D_FrameMeshMixin, OD3D_FrameTformObjMixin, OD3D_CamProj4x4ObjMixin, \
    ...
    OD3D_FrameCategoryMixin, OD3D_FrameSizeMixin, OD3D_FrameBBoxMixin, OD3D_FrameKpts2d3dMixin
