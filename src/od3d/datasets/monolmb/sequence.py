...
@dataclass
class MonoLMB_Sequence(OD3D_SequenceTformObjMixin, OD3D_SequenceMeshMixin, OD3D_SequenceCategoryMixin, OD3D_MaskTypeMixin, OD3D_CamTform4x4ObjTypeMixin, OD3D_Sequence):
