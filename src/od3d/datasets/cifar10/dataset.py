...
from od3d.datasets.cifar10.enum import MAP_CATEGORIES_OD3D_TO_CIFAR10, CIFAR10_CATEGORIES
...
class CIFAR10(OD3D_Dataset):
    ...
    def setup(config):
        ...
        import torchvision
        pt_cifar10_train = torchvision.datasets.CIFAR10(root=str(path_pascal3d_raw), train=True, transform=None,
                                                        target_transform=None, download=True)
        pt_cifar10_test = torchvision.datasets.CIFAR10(root=str(path_pascal3d_raw), train=False, transform=None,
                                                        target_transform=None, download=True)
    ...
    def extract_meta(config: DictConfig):
        ...
        pt_cifar10_train = torchvision.datasets.CIFAR10(root=str(path_pascal3d_raw), train=True, transform=torchvision.transforms.ToTensor(),
                                                        target_transform=None, download=True)
        pt_cifar10_test = torchvision.datasets.CIFAR10(root=str(path_pascal3d_raw), train=False, transform=torchvision.transforms.ToTensor(),
                                                        target_transform=None, download=True)
        ...
        for subset_name, subset in subsets.items():
            ...
            for i, batch in tqdm(enumerate(iter(dataloader))):
                ...
                frame_meta = CIFAR10_FrameMeta(subset=subset_name, category=category, name=name, rfpath_rgb=rfpath,
