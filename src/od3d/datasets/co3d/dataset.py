...
class CO3D_Sequence():
    ...
    def fpath_cuboid(self):
        return self.path_preprocess.joinpath('cuboids', self.category, self.name + '.ply')
    @property
...
class CO3D_Frame(OD3D_Frame):
    ...
    def cam_tform4x4_obj(self):
        if self._cam_tform4x4_obj is None:
            if self.return_cam_tform4x4_cuboid_front and self.sequence.cuboid_front_tform4x4_obj_labeled:
