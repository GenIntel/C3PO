...
ALLOW_LIST_FRAME_TYPES = [
    CO3D_FRAME_TYPES.DEV_KNOWN,
    CO3D_FRAME_TYPES.DEV_UNSEEN,
    CO3D_FRAME_TYPES.TRAIN_KNOWN,
    CO3D_FRAME_TYPES.TRAIN_UNSEEN,
...
MAP_CO3D_PASCAL3D_NOT_NONE = {
    key: value for key, value in MAP_CO3D_PASCAL3D.items() if value is not None
}
# map total: 10
# pascal3d total: 12
...
MAP_CO3D_OBJECTNET3D_NOT_NONE = {
    key: value for key, value in MAP_CO3D_OBJECTNET3D.items() if value is not None
}
# map total: 22
...
MAP_CO3D_COCO_NOT_NONE = {
    key: value for key, value in MAP_CO3D_COCO.items() if value is not None
}
# map total: 51
# coco total: 80
# excluded 29:
