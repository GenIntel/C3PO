...
from od3d.utils import prepare_pascal3d_sample_det
...
def download_ood_cv(cfg):
    ...
    ood_cv_pose_data_path = cfg.ood_cv_pose_data_path
...
def prepare_ood_cv(cfg):
    ood_cv_path = cfg.root_path
    dtd_raw_path = cfg.dtd_raw_path
...
def worker(params):
    ...
    for idx, sample in enumerate(all_samples):
        ...
        prepared_sample_names = prepare_pascal3d_sample_det(
            cate,
            img_name,
            img_path,
            anno_path,
