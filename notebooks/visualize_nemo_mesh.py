...
img  = show_scene2d([feats_all_cats_tsne], pts2d_colors=[feats_all_colors], return_visualization=True)
...
img.show()
print(img)
show_scene(pts3d=[feats_all_cats_tsne[:]], pts3d_colors=[torch.tensor([sublist[:3] for sublist in feats_all_colors])])